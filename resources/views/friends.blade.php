...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{URL::asset('public/assets/Css/Friend.css') }}">
    ...
    <div class="row">
        <div class="col-sm-3">
            <img
                    ...
                    @else
                        src="{{URL::asset('public/assets/User_image/'.$user['user_image'] )}}"
                    @endif
        ...
        <div class="col-sm-9" >
            ...
            <form method="POST" action="{{ route('relation.store') }}">
                ...
                <input type="submit"  class="btn btn-primary" value="Send friend Requset">
            </form>
        @endif
        </div>
    </div>
